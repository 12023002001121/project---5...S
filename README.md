...
- **Demo Video Script:** See [docs/DEMO_SCRIPT.md](file:///c:/Users/user/OneDrive/Desktop/Bluebelt/docs/DEMO_SCRIPT.md)
- **Pitch Deck Presentation:** See [docs/PITCH_DECK.md](file:///c:/Users/user/OneDrive/Desktop/Bluebelt/docs/PITCH_DECK.md)
- **Collected User Feedback Excel/CSV:** See [docs/user-feedback-export.csv](file:///c:/Users/user/OneDrive/Desktop/Bluebelt/docs/user-feedback-export.csv)

---

## 🔄 What We Changed and Why (Level 5 Iterations)

Based on actual user testing feedback, we implemented the following changes (tracked in [CHANGELOG.md](file:///c:/Users/user/OneDrive/Desktop/Bluebelt/CHANGELOG.md)):
...
- *Spreadsheet Export:* Survey data was exported from Google Forms as a CSV. The full 52-user cohort log is archived in [docs/user-feedback-export.csv](file:///c:/Users/user/OneDrive/Desktop/Bluebelt/docs/user-feedback-export.csv).
